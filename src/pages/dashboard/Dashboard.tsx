                ...
                <div className="lg:col-span-2">
                    ...
                    <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm h-full">
                        <div className="flex justify-between items-center mb-6">
                            <h3 className="text-lg font-bold text-slate-800">Recent Surgeries</h3>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-left">
                                ...
                                <tbody className="text-sm">
                                    {[
                                        { name: 'Appendectomy', status: 'In Progress', date: 'Oct 24, 2025', budget: '$4,500', statusColor: 'bg-blue-100 text-blue-600' },
                                        { name: 'Knee Replacement', status: 'Completed', date: 'Oct 21, 2025', budget: '$12,000', statusColor: 'bg-emerald-100 text-emerald-600' },
                                        { name: 'Cataract Surgery', status: 'Pending', date: 'Oct 19, 2025', budget: '$3,200', statusColor: 'bg-orange-100 text-orange-600' },
                                        { name: 'Heart Bypass', status: 'In Progress', date: 'Oct 15, 2025', budget: '$8,000', statusColor: 'bg-blue-100 text-blue-600' },
                                    ].map((project, i) => (
